 ...
 */
public class VehiculoVelazquezAguileraRaul2223 {
    ...
    public VehiculoVelazquezAguileraRaul2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoVelazquezAguileraRaul2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
